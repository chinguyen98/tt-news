...
<div class="row clearfix">
  <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12 center-block" style="float:none">
    <div class="card">
      ...
      <div class="body">
        <form class="form-horizontal" method="post" action="admin/nhomtin/laydulieuthem">
          @csrf
          <div class="row clearfix">
            ...
            <div class="col-sm-9">
              <div class="form-group">
                <div class="form-line">
                  <input type="text" class="form-control" placeholder="Tên nhóm tin" id="ten" name="Ten_nhomtin" value="{{old('Ten_nhomtin')}}">
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="row clearfix">
            <div class="col-lg-offset-2 col-md-offset-2 col-sm-offset-4 col-xs-offset-5">
              <button type="submit" class="btn btn-primary m-t-15 waves-effect">Thêm nhóm tin</button>
            </div>
          </div>
        </form>
      </div>
